		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind",
									"targetURL": "#TRAaplicativo2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TRAaplicativo2-display": {
								"semanticObject": "TRAaplicativo2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=TRA.aplicativo2",
									"url": sap.ui.require.toUrl("TRA/aplicativo2")
								}
							}
						}
					}
